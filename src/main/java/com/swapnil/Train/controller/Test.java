...
import com.swapnil.Train.entity.TrainSchedule;
import com.swapnil.Train.repo.StationRepository;
import com.swapnil.Train.repo.TrainRepository;
import com.swapnil.Train.repo.TrainScheduleRepository;
...
public class Test {
    ...
    public void test()
    {
        ...
        com.swapnil.Train.enitity.Train rajdhani = new com.swapnil.Train.enitity.Train(null,"Rajdhani Express","12306",null);
        com.swapnil.Train.enitity.Train durunto = new com.swapnil.Train.enitity.Train(null,"Durunto Express","12260",null);
        com.swapnil.Train.enitity.Train shatabdi = new com.swapnil.Train.enitity.Train(null,"Shatabdi Express","12043",null);
